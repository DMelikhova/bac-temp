...
def implode_fattened_df(df):
    ...
    for fill_name, fill_item in zip(df_grouped.index, df_grouped.values):
        ...
        current_values = fill_.loc[fill_name.split('||')[1], fill_name.split('||')[2], fill_name.split('||')[3]][
            fill_name.split('||')[0]]
        ...
        fill_.loc[fill_name.split('||')[1], fill_name.split('||')[2], fill_name.split('||')[3]][
            fill_name.split('||')[0]] = current_values_clean
